...
Account.prototype = {
    ...
    deposit : function(amount) {
        console.log("저금 전 잔액: %d", this.balance);
        this.balance += amount;
        console.log("저금 후 잔액: %d", this.balance);
    },
    withdraw : function(long_amount){
        if(this.balance < long_amount){
            console.log("잔액이 부족합니다.");
            console.log("잔액 : %d", this.balance);
        } else {
            console.log("출금 전 잔액: %d", this.balance);
            this.balance -= long_amount;
            console.log("출금 후 잔액: %d", this.balance);
        }
    },
