...
const student = {
    //  key: value, key2: value... 형식
    //  숫자, boolean, null, undefined는 따옴표 적용 X
...
/** 1) 각 데이터 출력하기 */
//  데이터에 접급하는 기본적인 방법은 객체이름.하위정보이름
//  --> 90% 이상의 경우에서 이 방식이 사용됨.
console.group("출력 type01");
